...
public class VillagerConvertEvent implements Listener {

    private final ZombieVillagerConverter plugin;
    private final ArrayList<LivingEntity> list;

    public VillagerConvertEvent(ZombieVillagerConverter plugin) {
        this.plugin = plugin;
